...
public class MechanicsToolLayout extends VBox {

    private final BorderPane card = new BorderPane();

    public MechanicsToolLayout(String titleText, String subtitleText, Runnable onBack) {
        Button backButton = new Button("Back to mechanics");
